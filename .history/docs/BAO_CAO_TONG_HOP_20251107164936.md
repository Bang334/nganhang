...
1	role_id	INT (PK, AI)	Mã vai trò
2	role_name	VARCHAR(50)	Tên vai trò (ví dụ: Teller, Manager)
3	description	VARCHAR(500)	Mô tả chi tiết
4	created_at	TIMESTAMP	Thời điểm tạo

Định nghĩa các vai trò trong hệ thống: CUSTOMER, TELLER, LOAN_OFFICER, ADMIN.
Bảng: Employees (Nhân viên)
STT	Tên cột	Kiểu dữ liệu	Mô tả
1	employee_id	INT (PK, AI)	Mã nhân viên
2	employee_code	VARCHAR(20)	Mã định danh nhân viên
3	branch_id	INT (FK)	Chi nhánh trực thuộc
4	role_id	INT (FK)	Vai trò trong hệ thống
5	full_name	VARCHAR(200)	Họ và tên
6	email	VARCHAR(100)	Email công việc
7	phone	VARCHAR(20)	Số điện thoại
8	username	VARCHAR(50)	Tên đăng nhập
9	password_hash	VARCHAR(255)	Mật khẩu mã hoá
10	status	ENUM('ACTIVE','INACTIVE')	Trạng thái làm việc
11	created_at	TIMESTAMP	Thời điểm tạo

Quản lý thông tin nhân viên: mã, tên, email, số điện thoại, vai trò, chi nhánh, tài khoản đăng nhập.
Bảng: Customers (Khách hàng)
STT	Tên cột	Kiểu dữ liệu	Mô tả
1	customer_id	INT (PK, AI)	Mã khách hàng
2	customer_code	VARCHAR(20)	Mã khách hàng duy nhất
3	full_name	VARCHAR(200)	Họ và tên
4	email	VARCHAR(100)	Email
5	phone	VARCHAR(20)	Số điện thoại
6	id_card_number	VARCHAR(20)	CCCD / CMND
7	date_of_birth	DATE	Ngày sinh
8	gender	ENUM('M','F','OTHER')	Giới tính
9	address	VARCHAR(500)	Địa chỉ
10	occupation	VARCHAR(100)	Nghề nghiệp
11	monthly_income	DECIMAL(18,2)	Thu nhập hàng tháng
12	registered_branch_id	INT (FK)	Chi nhánh đăng ký
13	username	VARCHAR(50)	Tên đăng nhập
14	password_hash	VARCHAR(255)	Mật khẩu mã hóa
15	status	ENUM('ACTIVE','INACTIVE')	Trạng thái
16	created_at	TIMESTAMP	Thời điểm tạo
...
STT	Tên cột	Kiểu dữ liệu	Mô tả
1	score_id	INT (PK, AI)	Mã điểm
2	customer_id	INT (FK, UNIQUE)	Khách hàng liên quan
3	score	INT	Điểm tín dụng (300–850)
4	grade	ENUM(...)	Hạng tín dụng
5	interest_rate	DECIMAL(5,2)	Lãi suất áp dụng
6	max_ltv	DECIMAL(5,2)	Tỷ lệ vay tối đa
7	on_time_payment_rate	INT	% trả đúng hạn
8	debt_to_income_ratio	DECIMAL(5,2)	Tỷ lệ nợ/thu nhập
9	account_age_months	INT	Thời gian sử dụng dịch vụ
10	total_outstanding_debt	DECIMAL(18,2)	Tổng dư nợ
11	late_payments	INT	Số lần trễ hạn
12	monthly_income	DECIMAL(18,2)	Thu nhập hàng tháng
13	last_updated	TIMESTAMP	Cập nhật gần nhất
...
STT	Cột	Kiểu	Mô tả
1	history_id	INT (PK, AI)	Mã bản ghi
2	customer_id	INT (FK)	Khách hàng
3	old_score	INT	Điểm cũ
4	new_score	INT	Điểm mới
5	score_change	INT	Mức thay đổi
6	old_grade	VARCHAR(10)	Hạng cũ
7	new_grade	VARCHAR(10)	Hạng mới
8	reason	VARCHAR(500)	Lý do thay đổi
9	event_type	ENUM(...)	Loại sự kiện
10	event_reference	VARCHAR(100)	Tham chiếu
11	created_by	INT (FK)	Nhân viên thực hiện
...
Bảng: AccountTypes
STT	Cột	Kiểu	Mô tả
1	account_type_id	INT (PK, AI)	Mã loại TK
2	type_code	VARCHAR(20)	Mã định danh
3	type_name	VARCHAR(100)	Tên loại TK
4	description	VARCHAR(500)	Mô tả
5	min_balance	DECIMAL(18,2)	Số dư tối thiểu
6	interest_rate	DECIMAL(5,2)	Lãi suất
7	status	ENUM	Trạng thái

Định nghĩa các loại tài khoản: thanh toán, tiết kiệm, với số dư tối thiểu và lãi suất.
Bảng: Accounts
STT	Cột	Kiểu	Mô tả
1	account_id	INT (PK, AI)	Mã TK
2	account_number	VARCHAR(20)	Số tài khoản
3	customer_id	INT (FK)	Chủ tài khoản
4	account_type_id	INT (FK)	Loại TK
5	branch_id	INT (FK)	Chi nhánh mở
6	balance	DECIMAL(18,2)	Số dư
7	interest_rate	DECIMAL(5,2)	Lãi suất hiện tại
8	opened_date	DATE	Ngày mở
9	status	ENUM	Trạng thái
...
Bảng: Cards
STT	Cột	Kiểu	Mô tả
1	card_id	INT (PK, AI)	Mã thẻ
2	card_number	VARCHAR(255)	Số thẻ (mã hoá)
3	account_id	INT (FK)	Tài khoản liên kết
4	card_type	ENUM	Loại thẻ (DEBIT/CREDIT)
5	issue_date	DATE	Ngày phát hành
6	expiry_date	DATE	Ngày hết hạn
7	status	ENUM	Trạng thái thẻ
8	created_at	TIMESTAMP	Ngày tạo

Quản lý thẻ ghi nợ/tín dụng: số thẻ (mã hóa), ngày phát hành, ngày hết hạn, hạn mức, trạng thái.

Bảng: TransactionTypes
STT	Cột	Kiểu	Mô tả
1	transaction_type_id	INT (PK, AI)	Mã loại GD
2	type_code	VARCHAR(20)	Mã định danh
3	type_name	VARCHAR(100)	Tên loại giao dịch
4	description	VARCHAR(500)	Mô tả
...
Bảng: Transactions
STT	Cột	Kiểu	Mô tả
1	transaction_id	BIGINT (PK, AI)	Mã GD
2	transaction_code	VARCHAR(50)	Mã giao dịch duy nhất
3	transaction_type_id	INT (FK)	Loại giao dịch
4	from_account_id	INT (FK)	TK gửi
5	to_account_id	INT (FK)	TK nhận
6	from_bank_name	VARCHAR(200)	Ngân hàng gửi
7	to_bank_name	VARCHAR(200)	Ngân hàng nhận
8	amount	DECIMAL(18,2)	Số tiền
9	fee	DECIMAL(10,2)	Phí giao dịch
10	description	VARCHAR(500)	Nội dung
11	balance_after	DECIMAL(18,2)	Số dư sau giao dịch
12	status	ENUM	Trạng thái
13	transaction_date	TIMESTAMP	Ngày thực hiện

Ghi nhận mọi giao dịch: mã giao dịch, tài khoản nguồn/đích, số tiền, phí, mô tả, số dư sau giao dịch, trạng thái.

Bảng: SavingsInterestRates
STT	Cột	Kiểu	Mô tả
1	rate_id	INT (PK, AI)	Mã lãi suất
2	term_months	INT	Kỳ hạn (tháng)
3	min_amount	DECIMAL(18,2)	Số tiền tối thiểu
4	max_amount	DECIMAL(18,2)	Số tiền tối đa
5	interest_rate	DECIMAL(5,2)	Lãi suất (%)
6	status	ENUM	Trạng thái
7	effective_from	DATE	Ngày hiệu lực
8	effective_to	DATE	Ngày kết thúc

Cấu hình lãi suất theo kỳ hạn: số tháng, số tiền tối thiểu/tối đa, lãi suất, thời gian hiệu lực.

Bảng: SavingsDeposits
STT	Cột	Kiểu	Mô tả
1	deposit_id	INT (PK, AI)	Mã sổ
2	deposit_number	VARCHAR(20)	Số sổ
3	customer_id	INT (FK)	Khách hàng
4	account_id	INT (FK)	TK nguồn
5	branch_id	INT (FK)	Chi nhánh
6	principal_amount	DECIMAL(18,2)	Tiền gốc
7	interest_rate_id	INT (FK)	Lãi suất tham chiếu
8	interest_rate	DECIMAL(5,2)	Lãi suất thực tế
9	term_months	INT	Kỳ hạn
10	start_date	DATE	Ngày gửi
11	maturity_date	DATE	Ngày đáo hạn
12	auto_renew	ENUM	Gia hạn tự động
13	total_interest_earned	DECIMAL(18,2)	Tổng lãi
14	status	ENUM	Trạng thái
...
Bảng: SavingsTransactions
STT	Cột	Kiểu	Mô tả
1	savings_transaction_id	INT (PK, AI)	Mã GD
2	deposit_id	INT (FK)	Sổ tiết kiệm
3	transaction_type	ENUM	Loại giao dịch
4	amount	DECIMAL(18,2)	Số tiền
5	interest_amount	DECIMAL(18,2)	Tiền lãi
6	description	VARCHAR(500)	Mô tả
7	transaction_date	TIMESTAMP	Ngày thực hiện

Ghi nhận các giao dịch liên quan đến tiết kiệm: gửi tiền, nhận lãi, rút trước hạn, rút đáo hạn, tái tục.

Bảng: CollateralTypes
STT	Cột	Kiểu	Mô tả
1	collateral_type_id	INT (PK, AI)	Mã loại tài sản
2	type_code	VARCHAR(20)	Mã loại
3	type_name	VARCHAR(100)	Tên loại
4	max_ltv	DECIMAL(5,2)	Tỷ lệ LTV tối đa

Định nghĩa loại tài sản: nhà đất, xe ô tô, với tỷ lệ LTV tối đa.

Bảng: Collaterals
STT	Cột	Kiểu	Mô tả
1	collateral_id	INT (PK, AI)	Mã tài sản
2	customer_id	INT (FK)	Chủ sở hữu
3	collateral_type_id	INT (FK)	Loại tài sản
4	collateral_name	VARCHAR(200)	Tên tài sản
5	description	TEXT	Mô tả
6	location	VARCHAR(500)	Vị trí
7	certificate_number	VARCHAR(100)	Giấy chứng nhận
8	issue_date	DATE	Ngày cấp
9	issue_authority	VARCHAR(200)	Cơ quan cấp
10	original_value	DECIMAL(18,2)	Giá trị gốc
11	appraised_value	DECIMAL(18,2)	Giá trị thẩm định
12	appraised_by	INT (FK)	Nhân viên thẩm định
13	appraised_date	DATE	Ngày thẩm định
14	status	ENUM	Trạng thái
15	verification_notes	VARCHAR(1000)	Ghi chú
16	created_at	TIMESTAMP	Ngày tạo
...
Bảng: LoanTypes
STT	Cột	Kiểu	Mô tả
1	loan_type_id	INT (PK, AI)	Mã loại vay
2	type_code	VARCHAR(20)	Mã định danh
3	type_name	VARCHAR(100)	Tên loại vay
4	description	VARCHAR(500)	Mô tả
5	max_amount	DECIMAL(18,2)	Hạn mức vay
6	max_term_months	INT	Thời hạn tối đa
7	require_collateral	ENUM	Có cần thế chấp không

Định nghĩa loại vay: vay mua nhà, vay tiêu dùng, vay kinh doanh, với số tiền và thời hạn tối đa, yêu cầu thế chấp.

Bảng: LoanInterestRates
STT	Cột	Kiểu	Mô tả
1	rate_id	INT (PK, AI)	Mã lãi suất vay
2	loan_type_id	INT (FK)	Loại vay
3	min_amount	DECIMAL(18,2)	Mức vay tối thiểu
4	max_amount	DECIMAL(18,2)	Mức vay tối đa
5	term_months_from	INT	Kỳ hạn từ
6	term_months_to	INT	Kỳ hạn đến
7	credit_grade	ENUM	Hạng tín dụng
8	base_rate	DECIMAL(5,2)	Lãi suất cơ bản
9	effective_from	DATE	Hiệu lực từ
10	effective_to	DATE	Đến ngày
11	status	ENUM	Trạng thái

Cấu hình lãi suất theo loại vay, số tiền, thời hạn, hạng tín dụng, thời gian hiệu lực.

Bảng: Loans
STT	Cột	Kiểu	Mô tả
1	loan_id	INT (PK, AI)	Mã khoản vay
2	loan_number	VARCHAR(20)	Mã khoản vay
3	customer_id	INT (FK)	Khách hàng
4	account_id	INT (FK)	TK liên kết
5	loan_type_id	INT (FK)	Loại vay
6	branch_id	INT (FK)	Chi nhánh
7	loan_officer_id	INT (FK)	NV phụ trách
8	loan_amount	DECIMAL(18,2)	Số tiền vay
9	approved_amount	DECIMAL(18,2)	Số được duyệt
10	interest_rate_id	INT (FK)	Lãi suất
11	interest_rate	DECIMAL(5,2)	Lãi suất thực tế
12	term_months	INT	Kỳ hạn vay
13	monthly_payment	DECIMAL(18,2)	Gốc + lãi hàng tháng
14	purpose	VARCHAR(500)	Mục đích vay
15	collateral_id	INT (FK)	Tài sản thế chấp
16	collateral_value	DECIMAL(18,2)	Giá trị TS
17	ltv_ratio	DECIMAL(5,2)	Tỷ lệ LTV
18	outstanding_balance	DECIMAL(18,2)	Dư nợ còn lại
19	application_date	DATE	Ngày đăng ký
20	approved_date	DATE	Ngày duyệt
21	approved_by	INT (FK)	Người duyệt
22	rejection_reason	VARCHAR(500)	Lý do từ chối
23	disbursement_date	DATE	Ngày giải ngân
24	first_payment_date	DATE	Ngày trả đầu tiên
25	maturity_date	DATE	Ngày đáo hạn
26	status	ENUM	Trạng thái
27	created_at	TIMESTAMP	Ngày tạo
...
Bảng: LoanPaymentSchedule
STT	Cột	Kiểu	Mô tả
1	schedule_id	INT (PK, AI)	Mã lịch trả
2	loan_id	INT (FK)	Khoản vay
3	payment_number	INT	Kỳ thanh toán
4	due_date	DATE	Ngày đến hạn
5	principal_amount	DECIMAL(18,2)	Tiền gốc
6	interest_amount	DECIMAL(18,2)	Tiền lãi
7	total_payment	DECIMAL(18,2)	Tổng phải trả
8	outstanding_balance	DECIMAL(18,2)	Dư nợ còn lại
9	status	ENUM	Trạng thái
10	paid_amount	DECIMAL(18,2)	Đã trả
11	paid_date	DATE	Ngày trả

Lịch trả nợ định kỳ: số kỳ, ngày đến hạn, số tiền gốc/lãi, tổng tiền, số dư nợ, trạng thái (chờ thanh toán/đã trả/quá hạn).
Bảng: LoanPayments
STT	Cột	Kiểu	Mô tả
1	payment_id	INT (PK, AI)	Mã thanh toán
2	loan_id	INT (FK)	Khoản vay
3	schedule_id	INT (FK)	Lịch trả
4	transaction_id	BIGINT (FK)	Mã giao dịch
5	payment_date	TIMESTAMP	Ngày thanh toán
6	principal_paid	DECIMAL(18,2)	Tiền gốc
7	interest_paid	DECIMAL(18,2)	Tiền lãi
8	late_fee_paid	DECIMAL(10,2)	Phí trễ hạn
9	total_paid	DECIMAL(18,2)	Tổng trả
10	payment_method	ENUM	Hình thức trả
11	reference_number	VARCHAR(100)	Mã tham chiếu
12	notes	VARCHAR(500)	Ghi chú
