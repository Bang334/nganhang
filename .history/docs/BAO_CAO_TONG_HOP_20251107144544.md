...
- Dashboard tổng quan:
  ...
  + Biểu đồ phân bố theo loại vay: Vay mua nhà (60%), Vay tiêu dùng (25%), Vay kinh doanh (15%)
  + Danh sách hồ sơ ưu tiên với điểm tín dụng và LTV
...
- Modal xem chi tiết hồ sơ:
  ...
  + Tài sản thế chấp (nếu có): Loại, Địa chỉ, Giấy chứng nhận, Giá trị, LTV với công thức rõ ràng
  + Danh sách hồ sơ đính kèm: CMND, Sổ hộ khẩu, Thu nhập, Tài sản (với trạng thái xác thực)
