...
Hệ thống được thiết kế với kiến trúc 3 tầng rõ ràng, database được normalize tốt với 19 bảng chính. Các trigger, stored procedures và views được đề xuất nhằm tự động hóa các nghiệp vụ quan trọng, đảm bảo tính nhất quán dữ liệu và giảm thiểu lỗi do xử lý thủ công.
