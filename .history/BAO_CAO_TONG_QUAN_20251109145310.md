...
### 2. Phân tích nhu cầu về giao diện người dùng
...
#### 2.2. Giao diện nhân viên giao dịch
...
#### 2.3. Giao diện nhân viên tín dụng
...
- **Data Layer**: MySQL database với 21 bảng

#### 3.2. Công nghệ sử dụng

**Frontend:**
- React 18: Component-based architecture, Virtual DOM, Ecosystem phong phú
- Vite 7.1.7: Fast HMR, Build nhanh, Tối ưu production
- React Router DOM 7.9.4: Declarative routing, Role-based routing
- Recharts 3.3.0: Biểu đồ đa dạng cho dashboard
- Lucide React: Icon đẹp, hiện đại

**Backend (Dự kiến):**
- Spring Boot hoặc Node.js + Express
- JWT Token: Stateless authentication
- RESTful API: Standard, Stateless, Resource-based

**Database:**
- MySQL 8.0: Mature, stable, ACID compliance
- InnoDB Engine: Transaction support, Foreign key constraints, Row-level locking
- Character Set utf8mb4: Unicode đầy đủ, hỗ trợ tiếng Việt
...
*Tài liệu này là phần III - PHÂN TÍCH VÀ THIẾT KẾ HỆ THỐNG của báo cáo đồ án Hệ thống Quản lý Ngân hàng.*
