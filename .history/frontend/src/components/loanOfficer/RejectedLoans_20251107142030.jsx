...
import { formatCurrency, formatDate, getRejectedLoansWithDetails } from '../../data/mockData';
...
const RejectedLoans = () => {
  ...
  // Lấy danh sách hồ sơ bị từ chối với đầy đủ thông tin
  const allRejectedLoans = getRejectedLoansWithDetails();
  
  const rejectedLoans_old = [
    {
      id: 1,
      loanNumber: 'LN002340',
