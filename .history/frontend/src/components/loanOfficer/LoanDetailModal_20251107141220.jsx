import { User, FileText, Home, TrendingUp, Calendar, Phone, Mail, MapPin, CheckCircle, XCircle } from 'lucide-react';
...
const LoanDetailModal = ({ isOpen, onClose, loanData }) => {
  ...
  const estimatedMonthlyPayment = loanData.loanAmount * (estimatedInterestRate/100/12 * Math.pow(1 + estimatedInterestRate/100/12, loanData.termMonths)) / (Math.pow(1 + estimatedInterestRate/100/12, loanData.termMonths) - 1);
