          ...
          <div>
            ...
            <div style={{
              ...
              <input
                ...
                placeholder="Nhập giá trị sau định giá"
                min="0"
                step="1000000"
                style={{
                  width: '100%',
              ...
              {appraisedValue && (
                <div style={{
                  ...
                  {formatCurrency(parseInt(appraisedValue) || 0)}
                </div>
              )}
            </div>
            <small className="text-secondary" style={{ display: 'block', marginTop: '0.5rem', fontSize: '0.8125rem' }}>
              Giá trị sau khi nhân viên định giá lại
            </small>
          </div>
        </div>
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Thẩm định & Duyệt tài sản">
      <form onSubmit={handleApprove}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div>
            <label className="form-label">Giá trị thẩm định (VND) *</label>
            <input
              type="number"
              className="form-control"
              value={appraisedValue}
              onChange={(e) => setAppraisedValue(e.target.value)}
              placeholder="Nhập giá trị thẩm định sau khi khảo sát"
              required
              min="0"
              step="1000000"
            />
            <small className="text-secondary">
              💡 Nhập giá trị sau khi khảo sát và đánh giá thực tế tài sản
            </small>
          </div>
