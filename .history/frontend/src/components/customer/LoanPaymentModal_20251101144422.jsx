...
const LoanPaymentModal = ({ isOpen, onClose, loan }) => {
  ...
  const canPayment = accountBalance >= totalPayment;
      ...
      <div className="payment-modal">
          ...
          <div className="payment-options">
            ...
            >
              ...
              <div className="option-content">
                ...
                <div className="option-note">Thanh toán theo lịch trả nợ</div>
              </div>
            </div>
        ...
        {!canPayment && (
          <div className="alert alert-warning">
            <AlertCircle size={18} />
            <span>Số dư tài khoản không đủ để thực hiện thanh toán!</span>
          </div>
        )}
