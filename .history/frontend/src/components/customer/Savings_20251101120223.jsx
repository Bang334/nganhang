...
const Savings = () => {
  ...
  // Handle maturity action (cả đã đáo hạn và sắp đáo hạn)
            ...
            <div key={deposit.deposit_id} className="card savings-card">
              ...
              {deposit.status === 'ACTIVE' && (
                <div className="savings-actions mt-3">
                  ...
                  {isNearMaturity ? (
                    /* SẮP đáo hạn (0-7 ngày): Hiện nút xem tùy chọn đáo hạn + xem chi tiết */
                    <>
                      <button 
                    ...
                    /* ĐÃ đáo hạn: Hiện nút rút trước hạn + xem chi tiết */
                    <div className="action-buttons">
                      <button 
