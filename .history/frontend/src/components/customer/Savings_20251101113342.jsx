            ...
            <div key={deposit.deposit_id} className="card savings-card">
              ...
              {deposit.status === 'ACTIVE' && (
                <div className="savings-actions mt-3">
                  ...
                  {isMatured ? (
                    /* ĐÃ đáo hạn: Chỉ hiện xem chi tiết, không có thao tác nào */
                    <div className="action-buttons">
                      ...
                      <div className="text-xs text-danger text-center mt-2">
                        ⚠️ Sổ đã đáo hạn. Vui lòng liên hệ ngân hàng để xử lý.
                      </div>
                    </div>
                  ) : isNearMaturity ? (
