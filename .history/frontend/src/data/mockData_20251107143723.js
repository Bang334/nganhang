  ...
  return loans
    ...
    .map(loan => {
      ...
      return {
        ...
        customerMonthlyIncome: customer?.monthly_income,
        // Loan info
        ...
        collateralValue: collateral?.appraised_value || collateral?.original_value,
        collateralType: collateralType?.type_name,
        collateralAddress: collateral?.location,
        collateralCertificate: collateral?.certificate_number,
        appraisedValue: collateral?.appraised_value,
        appraisedBy: appraisedByEmployee?.full_name || 'Công ty Thẩm định giá ABC',
        appraisedDate: collateral?.appraised_date,
