...
// Ngân hàng (để hỗ trợ chuyển khoản liên ngân hàng)
export const banks = [
  {
    bank_id: 1,
    bank_code: 'ABC',
...
export const getPendingLoansWithDetails = () => {
  return loans
    ...
    .map(loan => {
      ...
      // Build result object, ensuring customer fields are always set
      // Don't use ...loan to avoid overriding issues, explicitly set all fields
      const result = {
        // Loan base fields
